...
const PLANET_DETAIL = {
  ...
  JUPITER: "Sao Mộc - thường được nhiều nền văn minh xem như biểu tượng của may mắn, có hơn 95 mặt trăng, 4 mặt trăng lớn khám phá ra từ thời Galileo, khối lượng lớn, chủ yếu khí với lỏng, thể tích bất thường",
  ...
  NEPTUNE: "Sao Hải vương - cô độc ở rìa hệ, nơi đón những cơn cuồng phong khủng khiếp nhất với vận tốc vượt âm thanh (hơn 2.100 km/h) và những cơn mưa kim cương trong lòng hành tinh, cai quản chòm Song Ngư, trong many nền văn hóa, đây là hành tinh của những linh hồn và tư tưởng",
